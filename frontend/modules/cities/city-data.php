...
";
		...
		$pag_container = "";
        $pag_container .= "
		<div class='cvf-universal-pagination pagination-two pagination-center clearfix'>
		  <ul class='pagination'>
			";
			...
			$pre = $cur_page - 1;
			$pag_container .= "
			<li data-pnum='$pre' class='activelink'><a href='javascript:;'><i class='fa fa-chevron-left'></i></a></li>
			";
			} else if ($previous_btn) {
			$pag_container .= "
			<li class='inactive'><a href='javascript:;'><i class='fa fa-chevron-left'></i></a></li>
			";
			}
			...
			$nex = $cur_page + 1;
			$pag_container .= "
			<li data-pnum='$nex' class='activelink'><a href='javascript:;'><i class='fa fa-chevron-right'></i></a></li>
			";
			} else if ($next_btn) {
			$pag_container .= "
			<li class='inactive'><a href='javascript:;'><i class='fa fa-chevron-right'></i></a></li>
			";
			}
