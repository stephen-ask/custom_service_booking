...
<form class="get-quote" method="post">
  <div class="form-group">
    <input name="customer_name" id="customer_name" type="text" class="form-control" placeholder="<?php esc_html_e('Name', 'service-finder'); ?>" value="<?php echo esc_attr($fullname); ?>">
  </div>
  <div class="form-group">
    <input name="customer_email" id="customer_email" type="text" class="form-control" placeholder="<?php esc_html_e('Email', 'service-finder'); ?>" value="<?php echo esc_attr($email); ?>">
  </div>
  <div class="form-group">
    <input name="phone" type="text" class="form-control" placeholder="<?php esc_html_e('Phone', 'service-finder'); ?>" value="<?php echo esc_attr($phone); ?>">
  </div>
  <div class="form-group">
    <textarea name="description" id="description" class="form-control" placeholder="<?php esc_html_e('Message', 'service-finder'); ?>"></textarea>
  </div>
  <?php 
