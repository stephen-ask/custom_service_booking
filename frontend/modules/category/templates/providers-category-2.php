			...
			function service_finder_loadCategoryResult(page,viewtype,numberofpages,setorderby,setorder){
			  ...
			  jQuery.ajax({
								...
								jQuery(".loading-area").hide();
									...
									jQuery("#catresultfound").html(data["counttext"]);
...
<div class="section-content sf-caty-listResult-wrap" id="sf-cati-results">

	<div class="container">

        <div class="section-content">

            <?php echo do_action('service_finder_category_filter_style_4'); ?>
...
<div class="section-content sf-caty-listResult-wrap" id="sf-cati-results">
    ...
    <?php echo do_action('service_finder_category_filter_style_4',$setorderby,$setorder,$numberofpages,$viewtype,$defaultview); ?>
	  ...
	  if($showaddressinfo && $service_finder_options['show-postal-address'] && service_finder_check_address_info_access()){
...

	    {
		 ...
		 $srhcontent .= service_finder_display_provider_boxes($provider->wp_user_id,$viewtype,false);
			...
			$srhcontent .= service_finder_provider_box_fourth($provider->wp_user_id,$viewtype,false);
