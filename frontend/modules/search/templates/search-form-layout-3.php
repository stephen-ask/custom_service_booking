...
<input type="hidden" name="s" value="">
  ...
  <div class="sf-searchbar-box">
    <ul class="sf-searchbar-area sf-searchfileds-count-<?php echo esc_attr(count($searchoptions)); ?>">
      <?php if(service_finder_get_data($service_finder_options,'search-keyword')){ ?>
      <li>
        <div class="sf-search-title">  
            <h6><?php echo esc_html__('Keyword', 'service-finder'); ?></h6>
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('Location', 'service-finder'); ?></h6>
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('Category', 'service-finder'); ?></h6>
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('Country','service-finder') ?></h6>
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('State','service-finder') ?></h6>
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('City','service-finder') ?></h6>
            <span class="sf-search-icon"><img src="<?php echo SERVICE_FINDER_BOOKING_IMAGE_URL ?>/search-bar/city.png" alt=""/></span>
        </div>
        <div class="sf-search-feild">
      ...
      <li>
        <div class="sf-search-title">  
            <h6><?php echo esc_html__('Zipcode', 'service-finder'); ?></h6>
            <span class="sf-search-icon"><img src="<?php echo SERVICE_FINDER_BOOKING_IMAGE_URL ?>/search-bar/keyword.png" alt=""/></span>
        </div>
        <div class="sf-search-feild">
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('Filter by price interval', 'service-finder'); ?>:</h6>
            <span class="sf-search-icon"><img src="<?php echo SERVICE_FINDER_BOOKING_IMAGE_URL ?>/search-bar/city.png" alt=""/></span>
        </div>
        <div class="sf-search-feild">
            ...
            <b class="sf-left-value"><?php echo service_finder_money_format($minpricerange)?></b>
            <b class="sf-right-value"><?php echo service_finder_money_format($maxpricerange)?></b>
        </div>
      ...
      <li>
        <div class="sf-search-title">
            <h6><?php echo esc_html__('Filter by Radius', 'service-finder'); ?>:</h6>
            <span class="sf-search-icon"><img src="<?php echo SERVICE_FINDER_BOOKING_IMAGE_URL ?>/search-bar/city.png" alt=""/></span>
        </div>
        <div class="sf-search-feild">
            ...
            <b class="sf-left-value"><?php echo esc_html($minradiusrange).$radiusunit; ?></b>
            <b class="sf-right-value"><?php echo esc_html($maxradiusrange).$radiusunit; ?></b>
        </div>
    ...
    <button class="btn btn-primary sf-search-btn"><i class="fa fa-search"></i> <?php echo esc_html__('Search Now', 'service-finder'); ?></button>
  </div>
