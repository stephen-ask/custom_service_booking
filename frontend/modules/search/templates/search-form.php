...
$html = '';
$searchoptions = array();
if(service_finder_get_data($service_finder_options,'search-keyword') == true){
	$searchoptions[] = $service_finder_options['search-keyword'];
}
if(service_finder_get_data($service_finder_options,'search-category') == true){
	$searchoptions[] = $service_finder_options['search-category'];
}
if(service_finder_get_data($service_finder_options,'search-country') == true){
	$searchoptions[] = $service_finder_options['search-country'];
}
if(service_finder_get_data($service_finder_options,'search-city') == true){
	$searchoptions[] = $service_finder_options['search-city'];
}
if(service_finder_get_data($service_finder_options,'search-state') == true){
	$searchoptions[] = $service_finder_options['search-state'];
}
if(service_finder_get_data($service_finder_options,'search-zipcode') == true){
	$searchoptions[] = $service_finder_options['search-zipcode'];
}
if(service_finder_get_data($service_finder_options,'search-address') == true){
