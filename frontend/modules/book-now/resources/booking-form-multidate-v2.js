				...
				jQuery.ajax({
						...
						success:function (data, textStatus) {
							...
							if(data['status'] == 'success'){
								...
								jQuery( '<a href="javascript:;" class="remove-favorite" data-proid="'+providerid+'" data-userid="'+userid+'"><i class="fa fa-heart">Unfollow</a>' ).insertBefore( ".add-favorite" );
	...
	jQuery('body').on('click', '.remove-favorite', function(){
				...
				jQuery.ajax({
						...
						success:function (data, textStatus) {
							jQuery('.loading-area').hide();
							if(data['status'] == 'success'){
								jQuery( '<a href="javascript:;" class="add-favorite" data-proid="'+providerid+'" data-userid="'+userid+'"><i class="fa fa-heart">Follow</a>' ).insertBefore( ".remove-favorite" );
