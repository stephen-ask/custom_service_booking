...
<div class="page-content bg-white">
            ...
            <div class="sf-profile-banner-full">
                ...
                <div class="container sf-proBnrfull-container">
                    ...
                    <div class="sf-proBnrfull-row">
                        ...
                        <div class="sf-proBnrfull-left" style="background-image:url(<?php echo esc_url($coverbanner) ?>)">
                        ...
                        <div class=" sf-proBnrfull-right">
                            ...
                            <h2 class=" sf-proBnrfull-heading"><?php echo service_finder_getCompanyName($providerInfo->wp_user_id); ?></h2>

                            <div class=" sf-proBnrfull-tagline"><?php echo (!empty($providerInfo->tagline)) ? $providerInfo->tagline : service_finder_default_tagline(); ?></div>
            ...
            <div class="container">
                ...
                <div class="sf-provi-bio-box cleafix margin-b-50 sf-provi-fullBox">
                    ...
                    <div class="sf-provi-bio-left">
                        ...
                        <div class="sf-provi-bio-info">   
                            ...
                            <h6 class="sf-provi-name"><?php echo service_finder_getProviderFullName($author); ?></h6>
                    ...
                    <div class="sf-provi-bio-right">    
                        ...
                        <h3 class="sf-provi-title"><?php echo esc_html__('About', 'service-finder'); ?> <?php echo service_finder_getCompanyName($providerInfo->wp_user_id); ?></h3>
                        ...
                        <div class="sf-provi-social-row d-flex flex-wrap justify-content-between">
                            ...
                            <div class="social-share-icon social-share-icon2">
                              ...
                              <div class="social-share-cell">
                                  ...
                                  <strong><?php esc_html_e('Explore Us On Social Media', 'service-finder'); ?></strong>
                ...
                <div class="sf-provi-qoute-box cleafix margin-b-50 sf-provi-fullBox">

                    <h3 class="sf-provi-title"><?php echo esc_html($requestquote); ?></h3>
                	...
                	<div class="sf-provi-qform">
                    	...
                    	<div class="row">
                        	...
                        	<?php require SERVICE_FINDER_BOOKING_FRONTEND_MODULE_DIR . '/get-quote/templates/get-quote-layout-4.php'; ?>
                ...
                <div class="sf-provi-coInfo-box margin-b-50 sf-provi-fullBox" id="sf-provider-address">
				...
				<div class="sf-provi-vido-box margin-b-50 sf-provi-fullBox" id="sf-provider-video">
                ...
                <div class="sf-provi-articles-box margin-b-50 sf-provi-fullBox comments-area" id="sf-provider-review">

                    <h3 class="sf-provi-title"><?php echo service_finder_get_data($service_finder_options,'label-review',esc_html__('Review', 'service-finder')); ?></h3>
              ...
              <div class="sf-provi-articles-box margin-b-50 sf-provi-fullBox">
                    ...
                    <h3 class="sf-provi-title"><?php echo (!empty($service_finder_options['label-related-provider'])) ? esc_html($service_finder_options['label-related-provider']) : esc_html__('Related', 'service-finder').' '.service_finder_provider_replace_string(); ?></h3>

                    <div class="sf-divider-line"></div>

    

                    <div class="owl-carousel sf-ow-provi-related sf-owl-arrow">
                        ...
                        <strong class="sf-verified-label"><?php echo esc_html__( 'Verified', 'service-finder' ); ?></strong>
									...
									<div class="sf-ow-mid">
										...
										<p><?php echo service_finder_getExcerpts(nl2br(stripcslashes($provider->bio)),0,80); ?></p>
