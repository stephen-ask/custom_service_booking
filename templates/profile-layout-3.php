                ...
                <div class="section-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <?php } ?>
                            <?php if($providerInfo->website != "" && service_finder_get_data($service_finder_options,'show-skype')){ ?>
                            <div class="sf-icon-box left clearfix margin-b-20">
                                <div class="sf-border-icon">
                                        ...
                                        <div class="acod-head acc-actives">
                                             <h6 class="acod-title text-uppercase">
                                                <a data-toggle="collapse" href="#experience<?php echo $experience->id; ?>" data-parent="#experience-acord" >
                                                    ...
                                                    <span class="exper-date"><i class="fa fa-calendar"></i> <?php echo date('M d Y',strtotime($experience->start_date)); ?></span>
                                                    <?php }else{ ?>
                                                    <span class="exper-date"><i class="fa fa-calendar"></i> <?php echo date('M d Y',strtotime($experience->start_date)).' -  '.date('M d Y',strtotime($experience->end_date)); ?></span>
                                                    <?php } ?>
